package the.end2024.movieapp.ui.theme.colors
...
sealed class MovieColorSet {
    open lateinit var LightColors: MovieColors
    open lateinit var DarkColors: MovieColors

    object RedTheme : MovieColorSet() {
        override var LightColors = MovieColors(
        ...
        override var DarkColors = MovieColors(
    ...
    object BlueTheme : MovieColorSet() {
        override var LightColors = MovieColors(
            material = lightColorScheme(
                primary = Blue400,
